    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='mysql', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:\AttendenceManagement\Attendance Management System using Face Recognition\Attendance\Manually Attendance' + DB_table_name + '.csv'
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                date_for_DB = datetime.datetime.fromtimestamp(
                    ts).strftime('%Y_%m_%d')
                DB_Table_name = str(
                    Subject + "_" + date_for_DB + "_Time_" + Hour)
                import pymysql.connections
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='mysql', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                insert_data = "INSERT INTO " + DB_Table_name + \
                              " (ENROLLMENT, NAME, DATE, TIME) VALUES (%s, %s, %s, %s)"
                ...
                try:
                    ...
                    print("Query:", cursor.mogrify(insert_data, VALUES))
                ...
                root.configure(background='grey80')
                cs = 'D:\AttendenceManagement\Attendance Management System using Face Recognition\Attendance' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:\AttendenceManagement\Attendance Management System using Face Recognition\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                cs = 'D:\AttendenceManagement\Attendance Management System using Face Recognition\StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
